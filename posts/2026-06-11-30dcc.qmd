...
The 2026 challenge was organised by [Cédric Scherer](https://www.linkedin.com/in/cedscherer/) and [Dominic Royé](https://www.linkedin.com/in/dominicroye/).

The 30 prompts were split across five categories, as shown below:
...
For the 2026 edition, I managed to create six charts:
...
Here is the list of packages I used to create the charts:

| 📦 Package | Usage |
|----|----|
| [`{tidyverse}`](https://tidyverse.org/packages/) | Clean data and create plots |
| [`{palmerpenguins}`](https://allisonhorst.github.io/palmerpenguins/) | `penguins` dataset |
| [`{ggtext}`](https://wilkelab.org/ggtext/) | Add colours to text |
| [`{showtext}`](https://github.com/yixuan/showtext) | Use different fonts |
| [`{ggpop}`](https://jurjoroa.github.io/ggpop/index.html) | Create icon-based population charts |
| [`{marimekko}`](https://gogonzo.github.io/marimekko/index.html) | Create a mosaic plot |
| [`{patchwork}`](https://patchwork.data-imaginist.com/) | Group plots |
